(function() {
  ...
  Metafield = (function(_super) {
    ...
    Metafield.prototype.createForShop = function(fields, callback) {
      var url;
      url = this.resource.queryString("" + this.prefix + this.child);
      console.log(url);
      return this.resource.post(url, this.slug, fields, callback);
    };
    
    Metafield.prototype.deleteFromShop = function(id, callback) {
      var url;
      if (id == null) callback(new Error('missing'));
      url = this.resource.queryString("" + this.prefix + "/" + this.child + "/" + id);
