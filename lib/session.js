(function() {
  var Blog, Order, Product, ScriptTags, RecurringApplicationCharge, Session, crypto, empty, isNumeric, sortObj, trim;
  ...
  RecurringApplicationCharge = require('./recurring_application_charge')
